  ...
  return (
    <div className={classes.createElementLink__secondstep}>
      <div className={classes.createElementLink__secondstep__gradestep}>
        <div
          className={classes.createElementLink__secondstep__gradestep__grade}
        >
          <span
            className={
      ...
      <div className={classes.createElementLink__secondstep__union}>
        <span className={classes.createElementLink__secondstep__union__text}>
          Union
        </span>
        <Select
      ...
      <div className={classes.createElementLink__secondstep__additionalinfo}>
        <span
          className={
